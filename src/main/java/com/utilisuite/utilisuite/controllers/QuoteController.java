...
@Controller
@CrossOrigin(origins = {"http://localhost:3000", "http://localhost:8080", "http://18.224.41.247:8080", "18.224.41.247/:1"}) // Adds CORS to entire controller for the specified url
